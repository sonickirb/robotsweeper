...
#ode
#ODE_INCLUDE_PATH       ?= C:\raylib\otherlibs\ode\lib\include
#INCLUDE_PATHS += -I. -Iexternal -I$(ODE_INCLUDE_PATH)
...
#ode
#ODE_LIB_PATH ?= C/raylib/otherlibs/ode/lib
#LDFLAGS += -L. -L$(ODE_LIB_PATH)

#CFLAGS += -I C:\raylib\otherlibs\ode\lib\include
#LDFLAGS+=-L C:/raylib/otherlibs/ode/ode/src/.libs -lode
